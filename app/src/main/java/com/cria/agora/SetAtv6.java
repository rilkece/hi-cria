 ...
 */
public class SetAtv6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_set_atv06, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        question = view.findViewById(R.id.editQuestionAtv6);
        alt1 = view.findViewById(R.id.editAlterna1Atv6);
        alt2 = view.findViewById(R.id.editAlterna2Atv6);
        alt3 = view.findViewById(R.id.editAlterna3Atv6);
        alt4 = view.findViewById(R.id.editAlterna4Atv6);
        sentence = view.findViewById(R.id.editAltCertaAtv6);
        pointPlus = view.findViewById(R.id.maisAtv6);
        pointMinus = view.findViewById(R.id.menosAtv6);
        pooints = view.findViewById(R.id.pointsAtv6);
        imgBtnNextSet = view.findViewById(R.id.imgBtnNextSetAtv6);
        progressSet = view.findViewById(R.id.progressAtv6);
        descAtv6_2 = view.findViewById(R.id.descAtv6_2);
    ...
    private void postarAtividade() {
        ...
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("tipoAtv").setValue(6).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
