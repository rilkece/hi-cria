 ...
 */
public class SetAtv11 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_set_atv11, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        question = view.findViewById(R.id.editQuestionAtv11);
        alt1 = view.findViewById(R.id.editAlterna1Atv11);
        alt2 = view.findViewById(R.id.editAlterna2Atv11);
        alt3 = view.findViewById(R.id.editAlterna3Atv11);
        alt4 = view.findViewById(R.id.editAlterna4Atv11);
        sentence = view.findViewById(R.id.editAltCertaAtv11);
        pointPlus = view.findViewById(R.id.maisAtv11);
        pointMinus = view.findViewById(R.id.menosAtv11);
        pooints = view.findViewById(R.id.pointsAtv11);
        imgBtnNextSet = view.findViewById(R.id.imgBtnNextSetAtv11);
        progressSet = view.findViewById(R.id.progressAtv11);
        descAtv11_2 = view.findViewById(R.id.descAtv11_2);
        mStorageRef = FirebaseStorage.getInstance().getReference();
        editurlAtv11 = view.findViewById(R.id.editurlAtv11);
        ...
        descAtv11_2.setVisibility(View.VISIBLE);
        ...
        editurlAtv11.setVisibility(View.VISIBLE);
        ...
        imgBtnNextSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(question.getText().toString().equals("") || alt1.getText().toString().equals("") || alt2.getText().toString().equals("") || alt3.getText().toString().equals("") || alt4.getText().toString().equals("") || editurlAtv11.getText().toString().equals("") ){
                    ...
                    descAtv11_2.setVisibility(View.GONE);
                    ...
                    editurlAtv11.setVisibility(View.GONE);
    ...
    private void postarAtividade() {
        ...
        linkDownloadID = editurlAtv11.getText().toString();
        ...
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("tipoAtv").setValue(11).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
