 ...
 */
public class SetAtv12 extends Fragment {
    ...
    private EditText alt5;
    private EditText alt6;
    private EditText alt7;
    private EditText alt8;
    private EditText alt9;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_set_atv12, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        question = view.findViewById(R.id.editQuestionAtv12);
        alt1 = view.findViewById(R.id.editAlterna1Atv12);
        alt2 = view.findViewById(R.id.editAlterna2Atv12);
        alt3 = view.findViewById(R.id.editAlterna3Atv12);
        alt4 = view.findViewById(R.id.editAlterna4Atv12);
        alt5 = view.findViewById(R.id.editAlterna5Atv12);
        alt6 = view.findViewById(R.id.editAlterna6Atv12);
        alt7 = view.findViewById(R.id.editAlterna7Atv12);
        alt8 = view.findViewById(R.id.editAlterna8Atv12);
        alt9 = view.findViewById(R.id.editAlterna9Atv12);
        sentence = view.findViewById(R.id.editAltCertaAtv12);
        resposta = view.findViewById(R.id.editRespostaAtv12);
        pointPlus = view.findViewById(R.id.maisAtv12);
        pointMinus = view.findViewById(R.id.menosAtv12);
        pooints = view.findViewById(R.id.pointsAtv12);
        imgBtnNextSet = view.findViewById(R.id.imgBtnNextSetAtv12);
        progressSet = view.findViewById(R.id.progressAtv12);
        descAtv12_2 = view.findViewById(R.id.descAtv12_2);
        mStorageRef = FirebaseStorage.getInstance().getReference();
        editurlAtv12 = view.findViewById(R.id.editurlAtv12);
        ...
        descAtv12_2.setVisibility(View.VISIBLE);
        ...
        editurlAtv12.setVisibility(View.VISIBLE);
        ...
        imgBtnNextSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(question.getText().toString().equals("") || sentence.getText().toString().equals("") || resposta.getText().toString().equals("") ){
                    ...
                    alt5.setVisibility(View.GONE);
                    alt6.setVisibility(View.GONE);
                    alt7.setVisibility(View.GONE);
                    alt8.setVisibility(View.GONE);
                    alt9.setVisibility(View.GONE);
                    sentence.setVisibility(View.GONE);
                    question.setVisibility(View.GONE);
                    resposta.setVisibility(View.GONE);
                    descAtv12_2.setVisibility(View.GONE);
                    ...
                    editurlAtv12.setVisibility(View.GONE);
    ...
    private void postarAtividade() {
        String GdriveDownload = "";
        if (!editurlAtv12.getText().toString().equals("")){
            linkDownloadID = editurlAtv12.getText().toString();
            GdriveDownload = linkDownload1+linkDownloadID.substring(linkDownloadID.indexOf("d/") + 2, linkDownloadID.indexOf("/v"));
        }
        ...
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("tipoAtv").setValue(12).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressSet.setProgress(5);
            }
        });
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("parameters").child("alt1").setValue(alt1.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressSet.setProgress(6);
            }
        });
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("parameters").child("alt2").setValue(alt2.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressSet.setProgress(6);
            }
        });
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("parameters").child("alt3").setValue(alt3.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressSet.setProgress(7);
            }
        });
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("parameters").child("alt4").setValue(alt4.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressSet.setProgress(6);
            }
        });
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("parameters").child("alt5").setValue(alt5.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressSet.setProgress(6);
            }
        });
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("parameters").child("alt6").setValue(alt6.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressSet.setProgress(7);
            }
        });
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("parameters").child("alt7").setValue(alt7.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressSet.setProgress(6);
            }
        });
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("parameters").child("alt8").setValue(alt8.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressSet.setProgress(6);
            }
        });
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("parameters").child("alt9").setValue(alt9.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressSet.setProgress(7);
            }
        });
        dataSetAtv.child("pages").child("page"+SetActivity.ipaginaAtividade).child("parameters").child("resposta").setValue(resposta.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressSet.setProgress(7);
            }
